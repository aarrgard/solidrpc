...
using SolidRpc.Test.Vitec.Types.FarmInfo.Estate;
using System;
...
namespace SolidRpc.Test.Vitec.Types.Estate.Models {
    ...
    public class Farm {
        ...
        public SolidRpc.Test.Vitec.Types.Estate.Models.FarmInspection Inspection { get; set; }
        ...
        public IEnumerable<SolidRpc.Test.Vitec.Types.Estate.Models.Land> Lands { get; set; }
