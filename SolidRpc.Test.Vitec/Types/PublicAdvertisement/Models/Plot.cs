...
namespace SolidRpc.Test.Vitec.Types.PublicAdvertisement.Models {
    ...
    public class Plot {
        ...
        /// <summary>
        /// Projektid om tomten ing�r i ett projekt
        /// </summary>
        ...
        public SolidRpc.Test.Vitec.Types.PublicAdvertisement.Models.Marketing Marketing { get; set; }
    
        /// <summary>
        /// Utgifter
        /// </summary>
        [DataMember(Name="expenses",EmitDefaultValue=false)]
        public SolidRpc.Test.Vitec.Types.PublicAdvertisement.Models.PlotExpenses Expenses { get; set; }
