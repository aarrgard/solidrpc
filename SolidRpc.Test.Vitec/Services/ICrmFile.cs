...
using Models = SolidRpc.Test.Vitec.Types.File.Models;
namespace SolidRpc.Test.Vitec.Services {
    ...
    public interface ICrmFile {
        ...
        /// <param name="fileId">Filid</param>
        /// <param name="cancellationToken"></param>
        /// <exception cref="SolidRpc.Test.Vitec.Types.Services.CrmFile.CrmFileDelete.NoContentException">No Content</exception>
        Task CrmFileDelete(
            string customerId,
            string fileId,
            CancellationToken cancellationToken = default(CancellationToken));
