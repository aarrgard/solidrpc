...
namespace SolidRpc.Tests.Swagger.CodeGen.Vitec.Types.House.Cms {
    /// <summary>
    /// 
    /// </summary>
    ...
    public class CmsHouseInterior {
        ...
        public IEnumerable<SolidRpc.Tests.Swagger.CodeGen.Vitec.Types.House.Cms.Room> Rooms { get; set; }
