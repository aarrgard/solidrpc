...
namespace SolidRpc.Tests.Swagger.CodeGen.Vitec.Types.PublicAdvertisement.Models {
    ...
    public class Project {
        ...
        public SolidRpc.Tests.Swagger.CodeGen.Vitec.Types.PublicAdvertisement.Models.ProjectMarketing Marketing { get; set; }
        ...
        public IEnumerable<SolidRpc.Tests.Swagger.CodeGen.Vitec.Types.PublicAdvertisement.Models.ProjectEstateRelation> Houses { get; set; }
    
        /// <summary>
        /// Tomter som ing&#229;r i projektet
        /// </summary>
        [DataMember(Name="plots",EmitDefaultValue=false)]
        public IEnumerable<SolidRpc.Tests.Swagger.CodeGen.Vitec.Types.PublicAdvertisement.Models.ProjectEstateRelation> Plots { get; set; }
    
        /// <summary>
        /// Bostadsr&#228;tter som ing&#229;r i projektet
        /// </summary>
        [DataMember(Name="housingCooperatives",EmitDefaultValue=false)]
        public IEnumerable<SolidRpc.Tests.Swagger.CodeGen.Vitec.Types.PublicAdvertisement.Models.ProjectEstateRelation> HousingCooperatives { get; set; }
    
        /// <summary>
        /// &#196;garl&#228;genheter som ing&#229;r i projektet
        /// </summary>
        [DataMember(Name="condominiums",EmitDefaultValue=false)]
        public IEnumerable<SolidRpc.Tests.Swagger.CodeGen.Vitec.Types.PublicAdvertisement.Models.ProjectEstateRelation> Condominiums { get; set; }
    
        /// <summary>
        /// Lokaler som ing&#229;r i projektet
        /// </summary>
        [DataMember(Name="premises",EmitDefaultValue=false)]
        public IEnumerable<SolidRpc.Tests.Swagger.CodeGen.Vitec.Types.PublicAdvertisement.Models.ProjectEstateRelation> Premises { get; set; }
    
        /// <summary>
        /// Utl&#228;ndska bost&#228;der som ing&#229;r i projektet
        /// </summary>
        [DataMember(Name="foreignProperties",EmitDefaultValue=false)]
        public IEnumerable<SolidRpc.Tests.Swagger.CodeGen.Vitec.Types.PublicAdvertisement.Models.ProjectEstateRelation> ForeignProperties { get; set; }
    
        /// <summary>
        /// Fritidshus som ing&#229;r i projektet
        /// </summary>
        [DataMember(Name="cottages",EmitDefaultValue=false)]
        public IEnumerable<SolidRpc.Tests.Swagger.CodeGen.Vitec.Types.PublicAdvertisement.Models.ProjectEstateRelation> Cottages { get; set; }
