...
namespace SolidRpc.Tests.Swagger.CodeGen.Vitec.Types.SearchProfile.Models {
    ...
    public class SearchProfile {
        ...
        public IEnumerable<SolidRpc.Tests.Swagger.CodeGen.Vitec.Types.SearchProfile.Models.SearchProfileArea> Areas { get; set; }
    
        /// <summary>
        /// Lista p� kommuner.
        /// </summary>
        [DataMember(Name="municips",EmitDefaultValue=false)]
        public IEnumerable<SolidRpc.Tests.Swagger.CodeGen.Vitec.Types.SearchProfile.Models.SearchProfileMunicip> Municips { get; set; }
