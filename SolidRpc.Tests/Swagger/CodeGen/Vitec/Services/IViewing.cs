...
using Models = SolidRpc.Tests.Swagger.CodeGen.Vitec.Types.Viewing.Models;
...
namespace SolidRpc.Tests.Swagger.CodeGen.Vitec.Services {
    ...
    public interface IViewing {
        ...
        /// <param name="customerId">Kundid</param>
        /// <param name="cancellationToken"></param>
        /// <exception cref="SolidRpc.Tests.Swagger.CodeGen.Vitec.Types.Services.Viewing.ViewingAddViewingParticipant2.NoContentException">No Content</exception>
        ...
        /// <param name="customerId">Kundid</param>
        /// <param name="cancellationToken"></param>
        /// <exception cref="SolidRpc.Tests.Swagger.CodeGen.Vitec.Types.Services.Viewing.ViewingAddViewingParticipant.NoContentException">No Content</exception>
