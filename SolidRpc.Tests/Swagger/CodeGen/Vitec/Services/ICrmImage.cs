...
using SolidRpc.Tests.Swagger.CodeGen.Vitec.Types.Image.Models;
...
namespace SolidRpc.Tests.Swagger.CodeGen.Vitec.Services {
    ...
    public interface ICrmImage {
        ...
        /// <param name="imageId">Bildid</param>
        /// <param name="cancellationToken"></param>
        /// <exception cref="SolidRpc.Tests.Swagger.CodeGen.Vitec.Types.Services.CrmImage.CrmImageDelete.NoContentException">No Content</exception>
        Task CrmImageDelete(
            string customerId,
            string imageId,
            CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="imageData">Bilddata</param>
        /// <param name="cancellationToken"></param>
        /// <exception cref="SolidRpc.Tests.Swagger.CodeGen.Vitec.Types.Services.CrmImage.CrmImagePut.NoContentException">No Content</exception>
        Task CrmImagePut(
            string customerId,
            string imageId,
            ImageData imageData,
