...
namespace SolidRpc.OpenApi.AzFunctions
{
    ...
    public class Http_SolidRpc_Abstractions_Services_ISolidRpcHost_GetHostConfiguration
    {
        ...
        public static Task<HttpResponseMessage> Run(
            [HttpTrigger(AuthorizationLevel.Function, "get", Route = "SolidRpc/Abstractions/Services/ISolidRpcHost/GetHostConfiguration")] HttpRequestMessage req,
            [Inject] IServiceProvider serviceProvider,
            ILogger log,
            CancellationToken cancellationToken)
        {
    ...
    public class Http_SolidRpc_Abstractions_Services_ISolidRpcHost_SyncHostsFromStore
    {
        ...
        public static Task<HttpResponseMessage> Run(
            [HttpTrigger(AuthorizationLevel.Function, "get", Route = "SolidRpc/Abstractions/Services/ISolidRpcHost/SyncHostsFromStore")] HttpRequestMessage req,
            [Inject] IServiceProvider serviceProvider,
            ILogger log,
            CancellationToken cancellationToken)
        {
    ...
    public class Http_SolidRpc_Abstractions_Services_ISolidRpcHost_GetHostInstance
    {
        ...
        public static Task<HttpResponseMessage> Run(
            [HttpTrigger(AuthorizationLevel.Function, "get", Route = "SolidRpc/Abstractions/Services/ISolidRpcHost/GetHostInstance")] HttpRequestMessage req,
            [Inject] IServiceProvider serviceProvider,
            ILogger log,
            CancellationToken cancellationToken)
        {
    ...
    public class Http_SolidRpc_Abstractions_Services_ISolidRpcHost_GetHostId
    {
        ...
        public static Task<HttpResponseMessage> Run(
            [HttpTrigger(AuthorizationLevel.Function, "get", Route = "SolidRpc/Abstractions/Services/ISolidRpcHost/GetHostId")] HttpRequestMessage req,
            [Inject] IServiceProvider serviceProvider,
            ILogger log,
            CancellationToken cancellationToken)
        {
    ...
    public class Http_SolidRpc_Abstractions_Services_ISolidRpcHost_CheckHost
    {
        ...
        public static Task<HttpResponseMessage> Run(
            [HttpTrigger(AuthorizationLevel.Function, "post", Route = "SolidRpc/Abstractions/Services/ISolidRpcHost/CheckHost")] HttpRequestMessage req,
            [Inject] IServiceProvider serviceProvider,
            ILogger log,
            CancellationToken cancellationToken)
        {
    ...
    public class Http_SolidRpc_Test_Petstore_AzFunctionsV3_ITestInterface_MyFunc_arg0_arg1
    {
        ...
        public static Task<HttpResponseMessage> Run(
            [HttpTrigger(AuthorizationLevel.Function, "get", Route = "SolidRpc/Test/Petstore/AzFunctionsV3/ITestInterface/MyFunc/{arg0}/{arg1}")] HttpRequestMessage req,
            [Inject] IServiceProvider serviceProvider,
            ILogger log,
            CancellationToken cancellationToken)
        {
    ...
    public class Http_SolidRpc_Test_Petstore_AzFunctionsV3_ITestInterface_MyFunc_arg0
    {
        ...
        public static Task<HttpResponseMessage> Run(
            [HttpTrigger(AuthorizationLevel.Function, "get", Route = "SolidRpc/Test/Petstore/AzFunctionsV3/ITestInterface/MyFunc/{arg0}")] HttpRequestMessage req,
            [Inject] IServiceProvider serviceProvider,
            ILogger log,
            CancellationToken cancellationToken)
        {
    ...
    public class Http_SolidRpc_Test_Petstore_AzFunctionsV3_ITestInterface_UploadFile_arg0
    {
        ...
        public static Task<HttpResponseMessage> Run(
            [HttpTrigger(AuthorizationLevel.Function, "post", Route = "SolidRpc/Test/Petstore/AzFunctionsV3/ITestInterface/UploadFile/{arg0}")] HttpRequestMessage req,
            [Inject] IServiceProvider serviceProvider,
            ILogger log,
            CancellationToken cancellationToken)
        {
    ...
    public class Http_SolidRpc_OpenApi_AzQueue_Services_IAzTableQueue_ProcessTestMessage_arg0
    {
        ...
        public static Task<HttpResponseMessage> Run(
            [HttpTrigger(AuthorizationLevel.Function, "post", Route = "SolidRpc/OpenApi/AzQueue/Services/IAzTableQueue/ProcessTestMessage/{arg0}")] HttpRequestMessage req,
            [Inject] IServiceProvider serviceProvider,
            ILogger log,
            CancellationToken cancellationToken)
        {
    ...
    public class Http_SolidRpc_OpenApi_AzQueue_Services_IAzTableQueue_GetSettingsAsync
    {
        ...
        public static Task<HttpResponseMessage> Run(
            [HttpTrigger(AuthorizationLevel.Function, "get", Route = "SolidRpc/OpenApi/AzQueue/Services/IAzTableQueue/GetSettingsAsync")] HttpRequestMessage req,
            [Inject] IServiceProvider serviceProvider,
            ILogger log,
            CancellationToken cancellationToken)
        {
    ...
    public class Http_SolidRpc_OpenApi_AzQueue_Services_IAzTableQueue_FlagErrorMessagesAsPending
    {
        ...
        public static Task<HttpResponseMessage> Run(
            [HttpTrigger(AuthorizationLevel.Function, "get", Route = "SolidRpc/OpenApi/AzQueue/Services/IAzTableQueue/FlagErrorMessagesAsPending")] HttpRequestMessage req,
            [Inject] IServiceProvider serviceProvider,
            ILogger log,
            CancellationToken cancellationToken)
        {
    ...
    public class Http_SolidRpc_OpenApi_AzQueue_Services_IAzTableQueue_UpdateSettings
    {
        ...
        public static Task<HttpResponseMessage> Run(
            [HttpTrigger(AuthorizationLevel.Function, "post", Route = "SolidRpc/OpenApi/AzQueue/Services/IAzTableQueue/UpdateSettings")] HttpRequestMessage req,
            [Inject] IServiceProvider serviceProvider,
            ILogger log,
            CancellationToken cancellationToken)
        {
    ...
    public class Http_SolidRpc_OpenApi_AzQueue_Services_IAzTableQueue_ProcessMessageAsync_arg0_arg1_arg2
    {
        ...
        public static Task<HttpResponseMessage> Run(
            [HttpTrigger(AuthorizationLevel.Function, "get", Route = "SolidRpc/OpenApi/AzQueue/Services/IAzTableQueue/ProcessMessageAsync/{arg0}/{arg1}/{arg2}")] HttpRequestMessage req,
            [Inject] IServiceProvider serviceProvider,
            ILogger log,
            CancellationToken cancellationToken)
        {
    ...
    public class Http_SolidRpc_OpenApi_AzQueue_Services_IAzTableQueue_DispatchMessageAsync_arg0_arg1
    {
        ...
        public static Task<HttpResponseMessage> Run(
            [HttpTrigger(AuthorizationLevel.Function, "get", Route = "SolidRpc/OpenApi/AzQueue/Services/IAzTableQueue/DispatchMessageAsync/{arg0}/{arg1}")] HttpRequestMessage req,
            [Inject] IServiceProvider serviceProvider,
            ILogger log,
            CancellationToken cancellationToken)
        {
    ...
    public class Http_SolidRpc_OpenApi_AzQueue_Services_IAzTableQueue_SendTestMessageAync
    {
        ...
        public static Task<HttpResponseMessage> Run(
            [HttpTrigger(AuthorizationLevel.Function, "post", Route = "SolidRpc/OpenApi/AzQueue/Services/IAzTableQueue/SendTestMessageAync")] HttpRequestMessage req,
            [Inject] IServiceProvider serviceProvider,
            ILogger log,
            CancellationToken cancellationToken)
        {
    ...
    public class Http_SolidRpc_OpenApi_AzQueue_Services_IAzTableQueue_DoScheduledScanAsync
    {
        ...
        public static Task<HttpResponseMessage> Run(
            [HttpTrigger(AuthorizationLevel.Function, "get", Route = "SolidRpc/OpenApi/AzQueue/Services/IAzTableQueue/DoScheduledScanAsync")] HttpRequestMessage req,
            [Inject] IServiceProvider serviceProvider,
            ILogger log,
            CancellationToken cancellationToken)
        {
