    ...
    public class Timer_SolidRpc_Abstractions_Services_ISolidRpcHost_GetHostId_1
    {
        private ILogger _logger;
        private IServiceProvider _serviceProvider;
        public Timer_SolidRpc_Abstractions_Services_ISolidRpcHost_GetHostId_1(ILogger<Timer_SolidRpc_Abstractions_Services_ISolidRpcHost_GetHostId_1> logger, IServiceProvider serviceProvider) {
            _logger = logger;
            _serviceProvider = serviceProvider;
        }
        ...
        public Task Run(
            ...
            CancellationToken cancellationToken)
        {
            return TimerFunction.Run(timerInfo, _logger, _serviceProvider, "Timer_SolidRpc_Abstractions_Services_ISolidRpcHost_GetHostId_1", cancellationToken);
        }
    }
    ...
    public class Timer_SolidRpc_Test_Petstore_AzFunctionsV3_ITestInterface_RunNodeService_1
    {
        private ILogger _logger;
        private IServiceProvider _serviceProvider;
        public Timer_SolidRpc_Test_Petstore_AzFunctionsV3_ITestInterface_RunNodeService_1(ILogger<Timer_SolidRpc_Test_Petstore_AzFunctionsV3_ITestInterface_RunNodeService_1> logger, IServiceProvider serviceProvider) {
            _logger = logger;
            _serviceProvider = serviceProvider;
        }
        ...
        public Task Run(
            ...
            CancellationToken cancellationToken)
        {
            return TimerFunction.Run(timerInfo, _logger, _serviceProvider, "Timer_SolidRpc_Test_Petstore_AzFunctionsV3_ITestInterface_RunNodeService_1", cancellationToken);
        }
    }
