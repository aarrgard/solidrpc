...
namespace SolidRpc.Security.Services.OAuth2.Microsoft {
    ...
    public interface IOAuth2Microsoft {
        ...
        /// <param name="client_id">The Application (client) ID that the Azure portal – App registrations experience assigned to your app.</param>
        /// <param name="response_type">Must include id_token for OpenID Connect sign-in. It might also include other response_type values, such as code.</param>
        ...
        /// <param name="redirect_uri">The redirect URI of your app, where authentication responses can be sent and received by your app. It must exactly match one of the redirect URIs you registered in the portal, except that it must be URL encoded. If not present, the endpoint will pick one registered redirect_uri at random to send the user back to.</param>
        /// <param name="response_mode">Specifies the method that should be used to send the resulting authorization code back to your app. Can be form_post or fragment. For web applications, we recommend using response_mode=form_post, to ensure the most secure transfer of tokens to your application.</param>
        ...
        /// <param name="login_hint">You can use this parameter to pre-fill the username and email address field of the sign-in page for the user, if you know the username ahead of time. Often, apps use this parameter during reauthentication, after already extracting the username from an earlier sign-in by using the preferred_username claim.</param>
        ...
        Task Authorize(
            ...
            string nounce,
            Uri redirect_uri = default(Uri),
            string response_mode = default(string),
